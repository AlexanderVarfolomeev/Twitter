    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TwitterRolesTwitterUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TwitterRolesTwitterUsers_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TwitterRolesTwitterUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TwitterRolesTwitterUsers_RoleId",
                table: "TwitterRolesTwitterUsers",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_TwitterRolesTwitterUsers_UserId",
                table: "TwitterRolesTwitterUsers",
                column: "UserId");
        }
